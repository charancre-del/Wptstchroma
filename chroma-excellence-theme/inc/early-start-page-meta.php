...
function chroma_early_start_page_meta_boxes()
{
    ...
    if ($template !== 'page-early-start.php') {
        return;
    }
...
function chroma_early_start_template_note($post)
{
    ...
    echo esc_html__('These fields are used by the "Chroma Early Start" page template.', 'chroma-excellence');
    if ($template !== 'page-early-start.php') {
        echo ' ';
        echo esc_html__('This page is not currently using that template.', 'chroma-excellence');
    }
    echo '</p>';
}
