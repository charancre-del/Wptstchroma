                ...
                <div class="max-w-7xl mx-auto px-4 lg:px-6 grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <div class="flex flex-wrap gap-4">
                            ...
                            <?php 
                            // Reciprocal Linking: Path back to Parent Program and City
                            $parent_program_link = get_permalink($program);
                            $parent_city_link = $city_page ? get_permalink($city_page) : home_url('/communities/');
                            ?>
                            <div class="flex items-center gap-6 mt-2 ml-2">
                                <a href="<?php echo esc_url($parent_program_link); ?>" class="text-[10px] uppercase tracking-widest font-bold text-brand-ink/40 hover:text-chroma-blue transition-colors flex items-center gap-1.5">
                                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18 18.247 18.477 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
                                    About <?php echo esc_html($program->post_title); ?>
                                </a>
                                <a href="<?php echo esc_url($parent_city_link); ?>" class="text-[10px] uppercase tracking-widest font-bold text-brand-ink/40 hover:text-chroma-blue transition-colors flex items-center gap-1.5">
                                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                                    All in <?php echo esc_html($city_name); ?>
                                </a>
                            </div>
                            ...
                            <span class="flex items-center gap-2 text-sm font-bold text-brand-ink/60 px-4 py-4 ml-auto">
