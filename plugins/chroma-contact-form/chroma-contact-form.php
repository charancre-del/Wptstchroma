...
function chroma_contact_form_shortcode()
{
    ...
    ob_start();
    ?>
    <div class="chroma-contact-form-wrapper" data-lazy="<?php echo $lazy_load ? 'true' : 'false'; ?>" data-chroma-ghl-container="1" data-delay="<?php echo esc_attr($lazy_delay); ?>">
    ...
    <style>
        ...
        .chroma-contact-form-wrapper .chroma-ghl-form-placeholder {
            min-height: inherit;
...
function chroma_handle_contact_submission()
{
    ...
    // Webhook Integration
    $webhook_url = esc_url_raw(get_option('chroma_contact_webhook_url', ''));
