            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white rounded-xl border border-gray-200 p-6">
                    ...
                    <button
                        type="button"
                        disabled
                        className="text-primary-600/60 flex items-center gap-1 cursor-not-allowed"
                    >
                        Guide Coming Soon <ExternalLink className="w-4 h-4" />
                    </button>
                </div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6">
                    ...
                    <button
                        ...
                        className="text-primary-600/60 flex items-center gap-1 cursor-not-allowed"
                    >
                        FAQs Coming Soon <ExternalLink className="w-4 h-4" />
                    </button>
                </div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6">
                    ...
                    <a
                        href="mailto:support@chromaschools.com"
