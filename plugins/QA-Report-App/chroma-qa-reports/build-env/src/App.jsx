...
const ReportWizard = lazy( () =>
    import( /* webpackChunkName: "cqa-report-wizard" */ './components/wizard/ReportWizard' )
);
...
const RouteLoader = () => (
    <div className="flex items-center justify-center min-h-[45vh] text-brand-ink/70">Loading...</div>
);
