            ...
            <div className="flex items-center justify-between mb-4 sticky top-0 bg-cqa-brand-cream/90 backdrop-blur z-10 p-3 rounded-xl border border-cqa-brand-ink/10 shadow-sm">
                ...
                <div className="flex items-center gap-3">
                    <div className="flex flex-col items-end">
                        <span className="text-[9px] uppercase font-black text-cqa-brand-ink/40 leading-none mb-1">Section Progress</span>
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs font-bold text-cqa-brand-ink/70">{answeredItems}/{totalItems}</span>
                        </div>
                    </div>
                </div>
            </div>
