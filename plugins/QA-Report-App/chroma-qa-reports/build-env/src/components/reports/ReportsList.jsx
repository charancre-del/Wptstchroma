        ...
        () => [
            ...
            },
            {
                ...
                cell: ( info ) => {
                    ...
                    return (
                        <span
                            className={ `inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium uppercase tracking-wide ${ badgeClass }` }
                        >
                            { status || 'Draft' }
                        </span>
                    );
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="flex justify-between items-center">
                ...
                <Link
                    to="/create"
                    className="bg-cqa-primary text-white px-4 py-2 rounded-md hover:bg-indigo-700 transition font-medium"
                >
                    New Report
                </Link>
            </div>
