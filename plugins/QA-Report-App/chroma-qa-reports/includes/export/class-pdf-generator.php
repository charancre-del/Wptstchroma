    ...
    private function get_report_html(Report $report, $include_comparison = true)
    {
        ...
        <head>
            ...
            <style>
                * {
                ...
                .checklist-table th.col-item {
                    width: 40%;
                }

                .checklist-table th.col-rating {
                    width: 12%;
                    text-align: center;
                }

                .checklist-table th.col-previous {
                    width: 12%;
                    text-align: center;
                    background: #e8f5e9;
                }

                .checklist-table th.col-notes {
                    width: 24%;
                }

                .checklist-table th.col-comparison {
                    width: 12%;
                    background: #e8f5e9;
                }
                ...
                .checklist-table .rating-yes {
                    color: #16a34a;
                }

                .checklist-table .rating-sometimes {
                    color: #f59e0b;
                }

                .checklist-table .rating-no {
                    color: #dc2626;
                    font-weight: bold;
                }

                .checklist-table .rating-na {
                    color: #9ca3af;
                }
        ...
        <body>
            <?php if ($report->status !== 'approved'): ?>
                <div class="watermark">DRAFT REPORT</div>
            <?php endif; ?>
            <!-- Header -->
            <div class="header">
            ...
            <table class="meta-table">
                ...
                <?php if ($previous_report): ?>
                    <tr>
                        ...
                        <td colspan="3">
                            <?php echo esc_html(date_i18n('F j, Y', strtotime($previous_report->inspection_date))); ?> Report
                        </td>
                    </tr>
                <?php endif; ?>
            </table>
                        ...
                        <div class="poi-list">
                            <?php foreach ($ai_summary['poi'] as $item):
                                ...
                                <div class="poi-item" style="display: flex; align-items: flex-start; gap: 10px;">
                                    <span
                                        style="background: <?php echo $color; ?>; color: white; padding: 2px 6px; border-radius: 3px; font-size: 9pt; white-space: nowrap;">
                                        <?php echo esc_html($priority_label); ?>
                                    </span>
                                    <div>
                                        <div>✓ <?php echo esc_html($action); ?></div>
                                        <?php if ($timeline): ?>
                                            <div style="font-size: 9pt; color: #666; margin-top: 2px;">⏱ <?php echo esc_html($timeline); ?>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                        ...
                        <tbody>
                            <?php foreach ($section['items'] as $item):
                                ...
                                if (!empty($item_photos)):
                                    ?>
                                    <tr>
                                        <td colspan="<?php echo $previous_report ? 5 : 3; ?>"
                                            ...
                                            <div style="margin-top:5px;">
                                                <?php foreach ($item_photos as $photo): ?>
                                                    <div style="display:inline-block; margin-right:10px; width: 120px; vertical-align:top;">
                                                        <img src="<?php echo esc_url($photo->get_thumbnail_url(300)); ?>"
            ...
            foreach ($photos as $photo) {
                if (strpos($photo->section_key, '|') !== false)
                    continue; // Skip item photos
                    ...
                    <?php foreach ($grouped_photos as $section_key => $section_photos):
                        ...
                        <div style="margin-bottom: 20px;">
                            <?php if ($section_key !== 'general'): ?>
                                <h3
                                    style="font-size: 11pt; color: #374151; margin-bottom: 10px; border-bottom: 1px solid #e5e7eb; padding-bottom: 5px;">
                            ...
                            <div style="display: flex; flex-wrap: wrap; gap: 10px;">
                                <?php foreach ($section_photos as $photo): ?>
                                    <div
                                        style="width: 150px; border: 1px solid #ddd; border-radius: 6px; overflow: hidden; background: #fff;">
                                        <img src="<?php echo esc_url($photo->get_thumbnail_url(300)); ?>" alt=""
                                            style="width: 100%; height: 100px; object-fit: cover;">
                                        <?php if ($photo->caption): ?>
                                            <div
                                                style="padding: 6px; font-size: 9pt; color: #4b5563; background: #f9fafb; border-top: 1px solid #e5e7eb;">
