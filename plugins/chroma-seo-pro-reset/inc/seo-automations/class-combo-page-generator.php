...
class Chroma_Combo_Page_Generator
{
    ...
    // Provider registration moved to Chroma_Sitemap_Integrator::register_providers()
        ...
        <main class="combo-page bg-brand-cream">
            ...
            <section class="relative pt-20 pb-24 bg-white overflow-hidden">
                ...
                <div class="max-w-7xl mx-auto px-4 lg:px-6 grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        <?php if ($age_range): ?>
                            <div
                                class="inline-flex items-center gap-2 bg-chroma-blue/10 text-chroma-blue px-4 py-1.5 rounded-full text-[11px] font-bold uppercase tracking-widest mb-6">
                        ...
                        <h1 class="font-serif text-4xl md:text-5xl lg:text-6xl text-brand-ink mb-6 leading-tight">
                            ...
                            <span class="italic text-chroma-blue"><?php echo esc_html($city_name); ?>,
                                <?php echo esc_html($state); ?>.</span>
                        </h1>
                        ...
                        <div class="flex flex-wrap gap-4">
                            <a href="#tour"
                                class="inline-flex items-center justify-center px-8 py-4 rounded-full bg-chroma-blue text-white text-xs font-bold uppercase tracking-[0.2em] shadow-soft hover:bg-brand-ink transition-all">
                            ...
                            <?php if ($show_loc_details && $loc_address): ?>
                                <span class="flex items-center gap-2 text-sm font-bold text-brand-ink/60 px-4 py-4">
                                    <svg class="w-4 h-4 text-chroma-red" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <?php else: ?>
                                <span class="flex items-center gap-2 text-sm font-bold text-brand-ink/60 px-4 py-4">
                                    <svg class="w-4 h-4 text-chroma-blue" fill="currentColor" viewBox="0 0 20 20">
                                        <path
                    ...
                    <div
                        ...
                        <?php else: ?>
                            <div
                                class="w-full h-full bg-gradient-to-br from-chroma-blue/20 to-chroma-red/20 flex items-center justify-center">
            ...
            <section class="py-20 bg-brand-cream">
                <div class="max-w-7xl mx-auto px-4 lg:px-6">
                    ...
                    <div class="grid md:grid-cols-3 gap-8">
                        ...
                        <div class="bg-white p-8 rounded-3xl shadow-sm border border-brand-ink/5">
                            <div
                                class="w-12 h-12 bg-chroma-yellow/10 text-chroma-yellow rounded-xl flex items-center justify-center text-xl mb-4">
                                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                                    <path
                        ...
                        <div class="bg-white p-8 rounded-3xl shadow-sm border border-brand-ink/5">
                            <div
                                class="w-12 h-12 bg-chroma-green/10 text-chroma-green rounded-xl flex items-center justify-center text-xl mb-4">
                                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
            ...
            <section id="tour" class="py-24 bg-chroma-blueDark text-white">
                <div class="max-w-7xl mx-auto px-4 text-center">
                    ...
                    if (!empty($nearby_ids) && is_array($nearby_ids)):
                        ...
                        ?>
                        <h2 class="font-serif text-3xl md:text-4xl font-bold mb-6"><?php echo esc_html($str_locations_serving); ?>
                        </h2>
                        ...
                        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 text-left">
                            ...
                            while ($grid_query->have_posts()):
                                ...
                                ?>
                                <div
                                    class="group p-6 rounded-3xl bg-white text-brand-ink shadow-2xl transition-all hover:-translate-y-1">
                                    ...
                                    <?php endif; ?>
                                    <p class="text-xs font-bold uppercase tracking-widest mb-6 opacity-80">
                                        <?php echo esc_html($str_serving_families); ?></p>
                                    <div class="mt-auto">
                                        <a href="<?php the_permalink(); ?>"
                                            class="block w-full py-3 bg-chroma-blue text-white text-center rounded-xl text-xs font-bold uppercase tracking-widest hover:bg-brand-ink transition-colors">
                    ...
                    <?php else: ?>
                        ...
                        <div class="max-w-3xl mx-auto">
                            <h2 class="font-serif text-3xl md:text-4xl font-bold mb-6"><?php echo esc_html($str_visit_classroom); ?>
                            </h2>
            ...
            <section class="py-24 bg-white border-t border-brand-ink/5">
                <div class="max-w-4xl mx-auto px-4">
                    ...
                    <div class="space-y-4">
                        <details
                            class="group bg-brand-cream rounded-2xl p-6 shadow-sm border border-brand-ink/5 cursor-pointer">
                            <summary class="flex items-center justify-between font-bold text-brand-ink list-none">
                                <span>What are the tuition rates for <?php echo esc_html($program->post_title); ?> in
                            ...
                            <p class="mt-3 text-sm text-brand-ink/70 leading-relaxed">
                                Tuition varies based on the specific program and schedule (full-time vs. part-time). Please
                                schedule a tour to receive a detailed tuition sheet for our <?php echo esc_html($city_name); ?>
                                campus.
                            </p>
                        </details>
                        ...
                        <?php if ($age_range): ?>
                            <details
                                ...
                                <p class="mt-3 text-sm text-brand-ink/70 leading-relaxed">
                                    Our <?php echo esc_html($program->post_title); ?> program serves children ages
    ...
    public function render_admin_page()
    {
        ...
        <div class="wrap">
            ...
            <div class="combo-stats" style="display: flex; gap: 20px; margin: 20px 0;">
                <div class="stat-box"
                    style="background: #fff; border: 1px solid #ccc; padding: 15px 25px; border-radius: 8px; text-align: center;">
            ...
            <div class="tablenav top" style="margin-bottom: 15px;">
                ...
                <div class="alignright" style="display: flex; gap: 10px; align-items: center;">
                    ...
                    <span>Showing <?php echo $offset + 1; ?>–<?php echo $offset + $showing_count; ?> of
                        <?php echo $total; ?></span>
                </div>
            </div>
            ...
            <table class="wp-list-table widefat fixed striped" id="combo-table">
                ...
                <tbody>
                    <?php foreach ($display_combos as $i => $combo):
                        ...
                        ?>
                        <tr data-program="<?php echo esc_attr($program_slug); ?>" data-city="<?php echo esc_attr($city_slug); ?>"
                            ...
                            <td>
                                ...
                                <?php if ($combo['data']['ai_generated']): ?>
                                    <span
                                        style="background: #e7f3ff; color: #0073aa; padding: 2px 6px; border-radius: 3px; font-size: 10px; margin-left: 5px;">AI</span>
                                <?php endif; ?>
                            </td>
                            <td>
                            ...
                            <td>
                                <a href="<?php echo esc_url($combo['url']); ?>" target="_blank"
                                    class="button button-small">Preview</a>
                                ...
                                <button type="button" class="button button-small ai-translate-btn"
                                    title="Translate to Spanish">🌐</button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
                        ...
                        <span class="pagination-links">
                            <?php if ($paged > 1): ?>
                                <a class="first-page button"
                                    href="<?php echo esc_url($base_url . '&paged=1&per_page=' . $per_page); ?>">«</a>
                                <a class="prev-page button"
                                    href="<?php echo esc_url($base_url . '&paged=' . ($paged - 1) . '&per_page=' . $per_page); ?>">‹</a>
                            <?php else: ?>
                            ...
                            <?php if ($paged < $total_pages): ?>
                                ...
                                <a class="last-page button"
                                    href="<?php echo esc_url($base_url . '&paged=' . $total_pages . '&per_page=' . $per_page); ?>">»</a>
                            <?php else: ?>
                                <span class="button disabled">›</span>
                                <span class="button disabled">»</span>
                            <?php endif; ?>
            ...
            <?php if (class_exists('Chroma_Near_Me_Pages') && method_exists('Chroma_Near_Me_Pages', 'get_all_pages')): ?>
                        ...
                        <tbody>
                            ...
                            foreach ($near_pages as $np):
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge"
                                            style="background: <?php echo $np['type'] === 'Generic' ? '#e5e5e5' : '#e7f3ff; color: #0073aa'; ?>; padding: 2px 6px; border-radius: 3px; font-size: 11px;"><?php echo esc_html($np['type']); ?></span>
                                    </td>
                                    <td><?php echo esc_html($np['city'] !== '—' ? $np['city'] . ', ' . $np['state'] : 'Global'); ?></td>
                                    <td>
                                        <a href="<?php echo esc_url($np['url']); ?>" target="_blank"
                                            class="button button-small">Preview</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                ...
                <p class="description" style="margin-top: 5px;">These pages are virtual and generated instantly for users. They are
                    automatically included in the sitemap.</p>
            <?php endif; ?>
        ...
        <!-- Edit Modal -->
        <div id="combo-edit-modal"
            style="display: none; position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0,0,0,0.5); z-index: 100000;">
            <div
                style="background: #fff; max-width: 600px; margin: 50px auto; padding: 20px; border-radius: 8px; max-height: 80vh; overflow-y: auto;">
                ...
                <table class="form-table">
                    <tr>
                        <th>Neighborhoods</th>
                        <td><input type="text" id="edit-neighborhoods" class="regular-text" style="width: 100%;"
                                placeholder="Downtown, North Side, South Side"></td>
                    </tr>
                    <tr>
                        <th>Major Road</th>
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="edit-employers" class="regular-text" style="width: 100%;"
                                placeholder="Northside Hospital, Delta"></td>
                    </tr>
                    <tr>
                        <th>County</th>
