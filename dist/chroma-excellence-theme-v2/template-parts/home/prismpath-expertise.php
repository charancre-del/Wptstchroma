...
$care_text = $card_2['text'] ?? __('Our educators are state-certified professionals who understand that the most important credential is kindness.', 'chroma-excellence');
$fuel_heading = $card_3['heading'] ?? __('Wholesome Fuel', 'chroma-excellence');
$fuel_text = $card_3['text'] ?? __('Organic, balanced meals served family-style to fuel growing minds.', 'chroma-excellence');
$safety_heading = $card_4['heading'] ?? __('Uncompromised Safety', 'chroma-excellence');
$safety_text = $card_4['text'] ?? __('Secure, monitored facilities with open-door transparency for parents.', 'chroma-excellence');
