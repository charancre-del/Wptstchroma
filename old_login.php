...
<div class="cqa-login-container">
    <div class="cqa-login-card">
        <div class="cqa-login-header">
            <div class="cqa-login-logo">≡ƒôï</div>
            <h1>QA Reports</h1>
        ...
        ?>
            <a href="<?php echo esc_url( $auth_url ); ?>" class="cqa-btn cqa-btn-google cqa-btn-block">
                <span class="cqa-google-icon">
